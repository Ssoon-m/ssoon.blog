...
## 번외
이전글들에서 다룬 [AlertDialog](https://ianlog.me/blog/alert-dialog-atoz)와 [애니메이션](https://ianlog.me/blog/alert-dialog-animation)적용까지 마치셨다면, FocusTrap을 적용하는 방법에 대해 설명하겠습니다.
