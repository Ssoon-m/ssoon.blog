---
title: 'VanillaJS로 SPA router와 DOM Diff기능 만들기'
date: 2024-03-07
...
[이전글](https://ianlog.me/blog/vanillajs-fc-react/vdom-to-dom)에서 구현한 Virtual DOM 그리고 Virtual DOM을 DOM에 올려주는 createElement를 토대로 spa router와 DOM diffing 기능을 만들어보겠습니다.
